...
public class MainActivity extends android.app.Activity {
    ...
    private void buildUI() {
        ...
        stats.addView(pStat, new LinearLayout.LayoutParams(0,dp(92),1));
        LinearLayout.LayoutParams sp = new LinearLayout.LayoutParams(0,dp(92),1);
        sp.setMargins(dp(10),0,0,0);
        stats.addView(sStat, sp);
        root.addView(stats);

        TextView title = tv("QUICK ACTIONS", 18, WHITE, true);
        title.setPadding(dp(4), dp(24), dp(4), dp(12));
        root.addView(title);
        ...
        grid1.addView(prod, new LinearLayout.LayoutParams(0,dp(138),1));
        LinearLayout.LayoutParams mp = new LinearLayout.LayoutParams(0,dp(138),1);
        ...
        grid2.addView(addP, new LinearLayout.LayoutParams(0,dp(138),1));
        LinearLayout.LayoutParams ap = new LinearLayout.LayoutParams(0,dp(138),1);
        ap.setMargins(dp(10),0,0,0);
        grid2.addView(addS, ap);
        root.addView(grid2);

        TextView toolsTitle = tv("TOOLS", 18, WHITE, true);
        toolsTitle.setPadding(dp(4), dp(24), dp(4), dp(12));
        ...
        for (int i=0;i<labels.length;i++) {
            ...
            LinearLayout.LayoutParams tp = new LinearLayout.LayoutParams(0,dp(78),1);
        ...
        footer.setPadding(dp(10), dp(24), dp(10), dp(18));
        root.addView(footer);
    ...
    private LinearLayout actionCard(String icon, String title, String desc, int accent) {
        ...
        TextView t = tv(title, 15, WHITE, true); t.setPadding(0,dp(6),0,dp(2));
        TextView d = tv(desc, 11, MUTED, false); d.setMaxLines(3);
        c.addView(i, new LinearLayout.LayoutParams(-1,dp(42)));
